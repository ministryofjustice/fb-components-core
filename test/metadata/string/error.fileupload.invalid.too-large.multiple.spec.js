...
const dataObject = require('~/metadata/string/error.fileupload.invalid.too-large.multiple.json')
const jsonSchema = require('~/specifications/string/error/string.error.schema.json')

const validator = compile(jsonSchema)

describe('~/metadata/string/error.fileupload.invalid.too-large.multiple.json', () => {
