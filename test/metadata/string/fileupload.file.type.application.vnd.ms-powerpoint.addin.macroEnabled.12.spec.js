...
const dataObject = require('~/metadata/string/fileupload.file.type.application.vnd.ms-powerpoint.addin.macroEnabled.12.json')
const jsonSchema = require('~/specifications/string/string.schema.json')

const validator = compile(jsonSchema)

describe('~/metadata/string/fileupload.file.type.application.vnd.ms-powerpoint.addin.macroEnabled.12.json', () => {
