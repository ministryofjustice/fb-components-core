...
const dataObject = require('~/metadata/string/fileupload.file.type.application.x-iwork-pages-sffpages.json')
const jsonSchema = require('~/specifications/string/string.schema.json')

const ajv = new Ajv()

describe('~/metadata/string/fileupload.file.type.application.x-iwork-pages-sffpages.json', () => {
