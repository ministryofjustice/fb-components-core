...
const dataObject = require('~/test/specifications/checkbox/checkbox.json')
const jsonSchema = require('~/specifications/checkbox/checkbox.schema.json')
...
describe('~/specifications/checkbox/checkbox.schema.json', () => {
