...
const dataObject = require('~/test/specifications/definition/string/definition.string.json')
const jsonSchema = require('~/specifications/definition/string/definition.string.schema.json')
...
describe('~/specifications/definition/string/definition.string.schema.json', () => {
