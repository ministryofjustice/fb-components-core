...
const dataObject = require('~/test/specifications/definition/fieldset/definition.fieldset.json')
const jsonSchema = require('~/specifications/definition/fieldset/definition.fieldset.schema.json')
...
describe('~/specifications/definition/fieldset/definition.fieldset.schema.json', () => {
