...
describe('~/specifications/definition/conditions/all/definition.conditions.all.schema.json', () => {
  ...
  describe('The json schema', () => {
    describe('Dereferencing', () => it('throws a `ReferenceError`', () => expect(dereference(jsonSchema)).to.be.rejectedWith(ReferenceError, /Circular \$ref pointer.*\/definition\/condition\/definition\.condition\.schema\.json/)))
