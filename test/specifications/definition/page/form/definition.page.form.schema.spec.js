...
const dataObject = require('~/test/specifications/definition/page/form/definition.page.form.json')
const jsonSchema = require('~/specifications/definition/page/form/definition.page.form.schema.json')
...
describe('~/specifications/definition/page/form/definition.page.form.schema.json', () => {
