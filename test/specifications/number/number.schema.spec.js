...
const dataObject = require('~/test/specifications/number/number.json')
const jsonSchema = require('~/specifications/number/number.schema.json')
...
describe('~/specifications/number/number.schema.json', () => {
