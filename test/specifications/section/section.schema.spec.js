...
const dataObject = require('~/test/specifications/section/section.json')
const jsonSchema = require('~/specifications/section/section.schema.json')

const ajv = new Ajv()

describe('~/specifications/section/section.schema.json', () => {
